...
var Transaction = /** @class */ (function (_super) {
    ...
    function Transaction(options) {
        var _this = this;
        options = options || _1.default.getDefaultOptions() || new options_1.default(integration_commerce_codes_1.default.TRANSACCION_COMPLETA, integration_api_keys_1.default.WEBPAY, environment_1.default.Integration);
     ...
     */
    Transaction.prototype.create = function (buyOrder, sessionId, amount, cvv, cardNumber, cardExpirationDate) {
     ...
     */
    Transaction.prototype.installments = function (token, installmentsNumber) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(token, api_constants_1.default.TOKEN_LENGTH, "token");
                return [2 /*return*/, request_service_1.default.perform(new requests_1.InstallmentsRequest(token, installmentsNumber), this.options)];
            });
        });
    };
    /**
     ...
     * a grace period.
     */
    Transaction.prototype.commit = function (token, idQueryInstallments, deferredPeriodIndex, gracePeriod) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, request_service_1.default.perform(commitRequest, this.options)];
            });
        });
    };
    /**
    ...
    Transaction.prototype.capture = function (token, buyOrder, authorizationCode, captureAmount) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                captureRequest = new requests_1.CaptureRequest(token, buyOrder, authorizationCode, captureAmount);
     ...
     */
    Transaction.prototype.increaseAmount = function (token, buyOrder, authorizationCode, amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(token, api_constants_1.default.TOKEN_LENGTH, "token");
                validation_util_1.default.hasTextWithMaxLength(buyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "buyOrder");
                validation_util_1.default.hasTextWithMaxLength(authorizationCode, api_constants_1.default.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.IncreaseAmountRequest(api_constants_1.default.WEBPAY_ENDPOINT + "/transactions/" + token + "/amount", this.options.commerceCode, buyOrder, authorizationCode, amount), this.options)];
            });
        });
    };
     ...
     * @param authorizationCode Transaction's authorization code
     */
    Transaction.prototype.increaseAuthorizationDate = function (token, buyOrder, authorizationCode) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(token, api_constants_1.default.TOKEN_LENGTH, "token");
                validation_util_1.default.hasTextWithMaxLength(buyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "buyOrder");
                validation_util_1.default.hasTextWithMaxLength(authorizationCode, api_constants_1.default.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.IncreaseAuthorizationDateRequest(api_constants_1.default.WEBPAY_ENDPOINT + "/transactions/" + token + "/authorization_date", this.options.commerceCode, buyOrder, authorizationCode), this.options)];
            });
        });
    };
     ...
     */
    Transaction.prototype.reversePreAuthorizedAmount = function (token, buyOrder, authorizationCode, amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(token, api_constants_1.default.TOKEN_LENGTH, "token");
                validation_util_1.default.hasTextWithMaxLength(buyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "buyOrder");
                validation_util_1.default.hasTextWithMaxLength(authorizationCode, api_constants_1.default.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.ReversePreAuthorizedAmountRequest(api_constants_1.default.WEBPAY_ENDPOINT + "/transactions/" + token + "/reverse/amount", this.options.commerceCode, buyOrder, authorizationCode, amount), this.options)];
            });
        });
    };
     ...
     * @param token Unique transaction identifier
     */
    Transaction.prototype.deferredCaptureHistory = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(token, api_constants_1.default.TOKEN_LENGTH, "token");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.GetDeferredCaptureHistoryRequest(api_constants_1.default.WEBPAY_ENDPOINT + "/transactions/" + token + "/details"), this.options)];
            });
        });
    };
    return Transaction;
