...
declare class MallTransaction extends BaseTransaction {
     ...
     */
    increaseAmount(token: string, childCommerceCode: string, childBuyOrder: string, authorizationCode: string, amount: number): Promise<any>;
     ...
     * @param authorizationCode Transaction's authorization code
     */
    increaseAuthorizationDate(token: string, childCommerceCode: string, childBuyOrder: string, authorizationCode: string): Promise<any>;
     ...
     * @param amount Amount to be increase
     */
    reversePreAuthorizedAmount(token: string, childCommerceCode: string, childBuyOrder: string, authorizationCode: string, amount: number): Promise<any>;
     ...
     * @param authorizationCode Transaction's authorization code
     */
    deferredCaptureHistory(token: string, childCommerceCode: string, childBuyOrder: string, authorizationCode: string): Promise<any>;
}
