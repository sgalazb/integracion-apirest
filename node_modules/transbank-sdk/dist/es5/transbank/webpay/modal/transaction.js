...
var requests_2 = require("../webpay_plus/requests");
...
var Transaction = /** @class */ (function (_super) {
    ...
    function Transaction(options) {
        var _this = this;
        options = options || _1.default.getDefaultOptions() || new options_1.default(integration_commerce_codes_1.default.WEBPAY_PLUS_MODAL, integration_api_keys_1.default.WEBPAY, environment_1.default.Integration);
     ...
     */
    Transaction.prototype.create = function (buyOrder, sessionId, amount) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                createRequest = new requests_1.ModalCreateRequest(buyOrder, sessionId, amount);
    ...
    Transaction.prototype.commit = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, request_service_1.default.perform(new requests_2.CommitRequest(token), this.options)];
            });
        });
    };
    /**
    ...
    Transaction.prototype.status = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(token, api_constants_1.default.TOKEN_LENGTH, "token");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.StatusRequest(token), this.options)];
            });
        });
    };
    /**
    ...
    Transaction.prototype.refund = function (token, amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(token, api_constants_1.default.TOKEN_LENGTH, "token");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.RefundRequest(token, amount), this.options)];
            });
        });
    };
    return Transaction;
