...
var MallTransaction = /** @class */ (function (_super) {
     ...
     */
    MallTransaction.prototype.authorize = function (username, tbkUser, parentBuyOrder, details) {
        return __awaiter(this, void 0, void 0, function () {
            var i, item, authorizeRequest;
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(username, api_constants_1.default.USER_NAME_LENGTH, "username");
                validation_util_1.default.hasTextWithMaxLength(tbkUser, api_constants_1.default.TBK_USER_LENGTH, "tbkUser");
                validation_util_1.default.hasTextWithMaxLength(parentBuyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "parentBuyOrder");
                ...
                authorizeRequest = new requests_1.AuthorizeRequest(username, tbkUser, parentBuyOrder, details);
                return [2 /*return*/, request_service_1.default.perform(authorizeRequest, this.options)];
            });
        });
    };
    /**
     ...
     */
    MallTransaction.prototype.status = function (buyOrder) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(buyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "buyOrder");
                return [2 /*return*/, request_service_1.default.perform(new requests_1.StatusRequest(buyOrder), this.options)];
            });
        });
    };
    /**
     ...
     */
    MallTransaction.prototype.refund = function (buyOrder, childCommerceCode, childBuyOrder, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var refundRequest;
            return __generator(this, function (_a) {
                ...
                validation_util_1.default.hasTextWithMaxLength(buyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "buyOrder");
                validation_util_1.default.hasTextWithMaxLength(childBuyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "childBuyOrder");
                refundRequest = new requests_1.RefundRequest(buyOrder, childCommerceCode, childBuyOrder, amount);
     ...
     */
    MallTransaction.prototype.capture = function (childCommerceCode, childBuyOrder, authorizationCode, captureAmount) {
        return __awaiter(this, void 0, void 0, function () {
            var captureRequest;
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(childCommerceCode, api_constants_1.default.COMMERCE_CODE_LENGTH, "childCommerceCode");
                ...
                captureRequest = new requests_1.CaptureRequest(childCommerceCode, childBuyOrder, captureAmount, authorizationCode);
     ...
     */
    MallTransaction.prototype.increaseAmount = function (childCommerceCode, childBuyOrder, authorizationCode, amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(childCommerceCode, api_constants_1.default.COMMERCE_CODE_LENGTH, "childCommerceCode");
                validation_util_1.default.hasTextWithMaxLength(childBuyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "childBuyOrder");
                validation_util_1.default.hasTextWithMaxLength(authorizationCode, api_constants_1.default.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.IncreaseAmountRequest(api_constants_1.default.ONECLICK_ENDPOINT + "/transactions/amount", childCommerceCode, childBuyOrder, authorizationCode, amount), this.options)];
            });
        });
    };
     ...
     * @param authorizationCode Transaction's authorization code
     */
    MallTransaction.prototype.increaseAuthorizationDate = function (childCommerceCode, childBuyOrder, authorizationCode) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(childCommerceCode, api_constants_1.default.COMMERCE_CODE_LENGTH, "childCommerceCode");
                validation_util_1.default.hasTextWithMaxLength(childBuyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "childBuyOrder");
                validation_util_1.default.hasTextWithMaxLength(authorizationCode, api_constants_1.default.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.IncreaseAuthorizationDateRequest(api_constants_1.default.ONECLICK_ENDPOINT + "/transactions/authorization_date", childCommerceCode, childBuyOrder, authorizationCode), this.options)];
            });
        });
    };
     ...
     * @param amount Amount to be increase
     */
    MallTransaction.prototype.reversePreAuthorizedAmount = function (childCommerceCode, childBuyOrder, authorizationCode, amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(childCommerceCode, api_constants_1.default.COMMERCE_CODE_LENGTH, "childCommerceCode");
                validation_util_1.default.hasTextWithMaxLength(childBuyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "childBuyOrder");
                validation_util_1.default.hasTextWithMaxLength(authorizationCode, api_constants_1.default.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.ReversePreAuthorizedAmountRequest(api_constants_1.default.ONECLICK_ENDPOINT + "/transactions/reverse/amount", childCommerceCode, childBuyOrder, authorizationCode, amount), this.options)];
            });
        });
    };
     ...
     * @param authorizationCode Transaction's authorization code
     */
    MallTransaction.prototype.deferredCaptureHistory = function (childCommerceCode, childBuyOrder, authorizationCode) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                validation_util_1.default.hasTextWithMaxLength(childCommerceCode, api_constants_1.default.COMMERCE_CODE_LENGTH, "childCommerceCode");
                validation_util_1.default.hasTextWithMaxLength(childBuyOrder, api_constants_1.default.BUY_ORDER_LENGTH, "childBuyOrder");
                validation_util_1.default.hasTextWithMaxLength(authorizationCode, api_constants_1.default.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
                return [2 /*return*/, request_service_1.default.perform(new requests_2.DeferredCaptureHistoryRequest(api_constants_1.default.ONECLICK_ENDPOINT + "/transactions/details", childCommerceCode, childBuyOrder, authorizationCode), this.options)];
            });
        });
    };
