...
declare class MallTransaction extends BaseTransaction {
     ...
     */
    increaseAmount(childCommerceCode: string, childBuyOrder: string, authorizationCode: string, amount: number): Promise<any>;
     ...
     * @param authorizationCode Transaction's authorization code
     */
    increaseAuthorizationDate(childCommerceCode: string, childBuyOrder: string, authorizationCode: string): Promise<any>;
     ...
     * @param amount Amount to be increase
     */
    reversePreAuthorizedAmount(childCommerceCode: string, childBuyOrder: string, authorizationCode: string, amount: number): Promise<any>;
     ...
     * @param authorizationCode Transaction's authorization code
     */
    deferredCaptureHistory(childCommerceCode: string, childBuyOrder: string, authorizationCode: string): Promise<any>;
}
