...
var StatusRequest = /** @class */ (function (_super) {
    ...
    function StatusRequest(buyOrder) {
        return _super.call(this, api_constants_1.default.ONECLICK_ENDPOINT + "/transactions/" + buyOrder, 'GET') || this;
    }
    StatusRequest.prototype.toJson = function () {
        return undefined;
    };
