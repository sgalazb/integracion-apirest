...
class MallTransaction extends BaseTransaction {
     ...
     */
    async authorize(username, tbkUser, parentBuyOrder, details) {
     ...
     */
    async refund(buyOrder, childCommerceCode, childBuyOrder, amount) {
     ...
     */
    async capture(childCommerceCode, childBuyOrder, authorizationCode, captureAmount) {
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
     ...
     */
    async increaseAmount(childCommerceCode, childBuyOrder, authorizationCode, amount) {
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new IncreaseAmountRequest(`${ApiConstants.ONECLICK_ENDPOINT}/transactions/amount`, childCommerceCode, childBuyOrder, authorizationCode, amount), this.options);
    }
     ...
     * @param authorizationCode Transaction's authorization code
     */
    async increaseAuthorizationDate(childCommerceCode, childBuyOrder, authorizationCode) {
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new IncreaseAuthorizationDateRequest(`${ApiConstants.ONECLICK_ENDPOINT}/transactions/authorization_date`, childCommerceCode, childBuyOrder, authorizationCode), this.options);
    }
     ...
     * @param amount Amount to be increase
     */
    async reversePreAuthorizedAmount(childCommerceCode, childBuyOrder, authorizationCode, amount) {
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new ReversePreAuthorizedAmountRequest(`${ApiConstants.ONECLICK_ENDPOINT}/transactions/reverse/amount`, childCommerceCode, childBuyOrder, authorizationCode, amount), this.options);
    }
     ...
     * @param authorizationCode Transaction's authorization code
     */
    async deferredCaptureHistory(childCommerceCode, childBuyOrder, authorizationCode) {
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new DeferredCaptureHistoryRequest(`${ApiConstants.ONECLICK_ENDPOINT}/transactions/details`, childCommerceCode, childBuyOrder, authorizationCode), this.options);
    }
}
;
