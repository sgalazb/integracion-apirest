...
class MallTransaction extends BaseTransaction {
    ...
    async create(buyOrder, sessionId, returnUrl, details) {
        ...
        return RequestService.perform(new MallCreateRequest(buyOrder, sessionId, returnUrl, details), this.options);
    }
    /**
    ...
    async refund(token, buyOrder, childCommerceCode, amount) {
        ...
        ValidationUtil.hasTextWithMaxLength(buyOrder, ApiConstants.BUY_ORDER_LENGTH, "buyOrder");
        return RequestService.perform(new MallRefundRequest(token, buyOrder, childCommerceCode, amount), this.options);
    }
    /**
     ...
     */
    async capture(childCommerceCode, token, buyOrder, authorizationCode, captureAmount) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(buyOrder, ApiConstants.BUY_ORDER_LENGTH, "buyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new MallCaptureRequest(token, childCommerceCode, buyOrder, authorizationCode, captureAmount), this.options);
    }
     ...
     */
    async increaseAmount(token, childCommerceCode, childBuyOrder, authorizationCode, amount) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new IncreaseAmountRequest(`${ApiConstants.WEBPAY_ENDPOINT}/transactions/${token}/amount`, childCommerceCode, childBuyOrder, authorizationCode, amount), this.options);
    }
     ...
     * @param authorizationCode Transaction's authorization code
     */
    async increaseAuthorizationDate(token, childCommerceCode, childBuyOrder, authorizationCode) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new IncreaseAuthorizationDateRequest(`${ApiConstants.WEBPAY_ENDPOINT}/transactions/${token}/authorization_date`, childCommerceCode, childBuyOrder, authorizationCode), this.options);
    }
     ...
     * @param amount Amount to be increase
     */
    async reversePreAuthorizedAmount(token, childCommerceCode, childBuyOrder, authorizationCode, amount) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new ReversePreAuthorizedAmountRequest(`${ApiConstants.WEBPAY_ENDPOINT}/transactions/${token}/reverse/amount`, childCommerceCode, childBuyOrder, authorizationCode, amount), this.options);
    }
     ...
     * @param childBuyOrder Child buy order, used to identify the correct child transaction.
     */
    async deferredCaptureHistory(token, childCommerceCode, childBuyOrder) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(childCommerceCode, ApiConstants.COMMERCE_CODE_LENGTH, "childCommerceCode");
        ValidationUtil.hasTextWithMaxLength(childBuyOrder, ApiConstants.BUY_ORDER_LENGTH, "childBuyOrder");
        return RequestService.perform(new DeferredCaptureHistoryRequest(`${ApiConstants.WEBPAY_ENDPOINT}/transactions/${token}/details`, childCommerceCode, childBuyOrder, ''), this.options);
    }
}
;
