...
class Transaction extends BaseTransaction {
     ...
     */
    async create(buyOrder, sessionId, amount, cvv, cardNumber, cardExpirationDate) {
        ...
        let createRequest = new CreateRequest(buyOrder, sessionId, amount, cvv, cardNumber.replace(/\s/g, ''), cardExpirationDate.replace(/\s/g, ''));
     ...
     */
    async installments(token, installmentsNumber) {
     ...
     * a grace period.
     */
    async commit(token, idQueryInstallments = undefined, deferredPeriodIndex = undefined, gracePeriod = undefined) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        let commitRequest = new CommitRequest(token, idQueryInstallments, deferredPeriodIndex, gracePeriod);
     ...
     */
    async capture(token, buyOrder, authorizationCode, captureAmount) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(buyOrder, ApiConstants.BUY_ORDER_LENGTH, "buyOrder");
     ...
     */
    async increaseAmount(token, buyOrder, authorizationCode, amount) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(buyOrder, ApiConstants.BUY_ORDER_LENGTH, "buyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new IncreaseAmountRequest(`${ApiConstants.WEBPAY_ENDPOINT}/transactions/${token}/amount`, this.options.commerceCode, buyOrder, authorizationCode, amount), this.options);
    }
     ...
     * @param authorizationCode Transaction's authorization code
     */
    async increaseAuthorizationDate(token, buyOrder, authorizationCode) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(buyOrder, ApiConstants.BUY_ORDER_LENGTH, "buyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new IncreaseAuthorizationDateRequest(`${ApiConstants.WEBPAY_ENDPOINT}/transactions/${token}/authorization_date`, this.options.commerceCode, buyOrder, authorizationCode), this.options);
    }
     ...
     */
    async reversePreAuthorizedAmount(token, buyOrder, authorizationCode, amount) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        ValidationUtil.hasTextWithMaxLength(buyOrder, ApiConstants.BUY_ORDER_LENGTH, "buyOrder");
        ValidationUtil.hasTextWithMaxLength(authorizationCode, ApiConstants.AUTHORIZATION_CODE_LENGTH, "authorizationCode");
        return RequestService.perform(new ReversePreAuthorizedAmountRequest(`${ApiConstants.WEBPAY_ENDPOINT}/transactions/${token}/reverse/amount`, this.options.commerceCode, buyOrder, authorizationCode, amount), this.options);
    }
     ...
     * @param token Unique transaction identifier
     */
    async deferredCaptureHistory(token) {
        ValidationUtil.hasTextWithMaxLength(token, ApiConstants.TOKEN_LENGTH, "token");
        return RequestService.perform(new GetDeferredCaptureHistoryRequest(`${ApiConstants.WEBPAY_ENDPOINT}/transactions/${token}/details`), this.options);
    }
}
;
