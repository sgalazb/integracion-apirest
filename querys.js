...
const obtieneProductosNombre = "SELECT DISTINCT P.ID , P.CODIGO, C.CAT_DESC, P.NOMBRE_PRODUCTO, P.CODIGO_SERIE, P.MODELO, P.S_TOTAL 'STOCK_TOTAL', P.S_MAIPU 'STOCK_MAIPU', P.S_SANTIAGO 'STOCK_SANTIAGO', P.S_VITACURA 'STOCK_VITACURA', P.S_PROVIDENCIA 'STOCK PROVIDENCIA', round(P.PRECIO_COMPRA,0) 'PRECIO_COMPRA', round(P.PRECIO_VENTA,0) 'PRECIO_VENTA', P.DESCRIPCION_PRODUCTO FROM PRODUCTOS P, CATEGORIAS C WHERE P.CATEGORIA = C.CAT_ID AND LOWER(P.NOMBRE_PRODUCTO) LIKE ?";

const obtieneProductos = "SELECT DISTINCT P.ID , P.CODIGO, C.CAT_DESC, P.NOMBRE_PRODUCTO, P.CODIGO_SERIE, P.MODELO, P.S_TOTAL 'STOCK_TOTAL', P.S_MAIPU 'STOCK_MAIPU', P.S_SANTIAGO 'STOCK_SANTIAGO', P.S_VITACURA 'STOCK_VITACURA', P.S_PROVIDENCIA 'STOCK_PROVIDENCIA', round(P.PRECIO_VENTA,0) 'PRECIO_VENTA', P.DESCRIPCION_PRODUCTO FROM PRODUCTOS P, CATEGORIAS C WHERE P.CATEGORIA = C.CAT_ID";

const obtieneProductosCod = "SELECT DISTINCT P.ID , P.CODIGO, C.CAT_DESC, P.NOMBRE_PRODUCTO, P.CODIGO_SERIE, P.MODELO, P.S_TOTAL 'STOCK_TOTAL', P.S_MAIPU 'STOCK_MAIPU', P.S_SANTIAGO 'STOCK_SANTIAGO', P.S_VITACURA 'STOCK_VITACURA', P.S_PROVIDENCIA 'STOCK_PROVIDENCIA', round(P.PRECIO_VENTA,0) 'PRECIO_VENTA', P.DESCRIPCION_PRODUCTO FROM PRODUCTOS P, CATEGORIAS C WHERE P.CATEGORIA = C.CAT_ID AND P.ID = ?";
